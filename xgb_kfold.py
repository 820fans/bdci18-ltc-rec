...
param = {'max_depth': 9, 'eta':0.05, 'eval_metric':'merror', 
    ...
    'n_estimators': 802, 'colsample_bytree': 0.9, 'colsample_bylevel': 0.9, 
         'silent':1, 'objective':'multi:softmax', 'num_class':11, 'seed': 2018}  # 参数
...
for i ,(train_fold,test_fold) in enumerate(skf):
    ...
    model_name = "model1015/xgb-kf-drop-1015-round %d" % i
...
submit['current_service'] = pd.Series(service_type, index=test.index)
