...
gbm = xgb.XGBClassifier(max_depth=9, n_estimators=765, learning_rate=0.05,
gamma=0, max_delta_step=0, subsample=1, colsample_bytree=0.8, colsample_bylevel=0.8,
...
# save model to file
pickle.dump(gbm, open("xgb-model-0930", "wb"))
